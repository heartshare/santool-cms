...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'label',array('size'=>60,'maxlength'=>512)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'resume'); ?>
		<?php echo $form->textField($model,'resume',array('size'=>60,'maxlength'=>1024)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'permalink',array('size'=>60,'maxlength'=>512)); ?>
	</div>
