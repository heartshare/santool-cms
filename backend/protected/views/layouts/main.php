			...
			<div id="header-top" class="row">
				<div class="span4">
					<a href="<?php echo Yii::app()->request->baseUrl; ?>/">
						<img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/dishub.png" alt="" />
					</a>
				</div>
				<div class="span8">
							...
							'items'=>array(
								array('label'=>'Home', 'url'=>array('/site/index')),
                                                                array('label'=>'Posts', 'url'=>'#', 'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown","data-description"=>""), 'itemOptions'=>array('class'=>'dropdown'), 'items'=>array(
                                                                    array('label'=>'All Posts', 'url'=>array('posts/admin'), 'itemOptions'=>array('class'=>'dropdown-submenu')),
                                                                ...
                                                                array('label'=>'Users', 'url'=>'#', 'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown","data-description"=>""), 'itemOptions'=>array('class'=>'dropdown'), 'items'=>array(
                                                                    array('label'=>'All Users', 'url'=>array('user/admin'), 'itemOptions'=>array('class'=>'dropdown-submenu')),
                                                                    array('label'=>'Add New', 'url'=>array('user/create'), 'itemOptions'=>array('class'=>'dropdown-submenu')),
                                                                    array('label'=>'Your Profile', 'url'=>array('user/view&id='.Yii::App()->user->getId()), 'itemOptions'=>array('class'=>'dropdown-submenu'))
                                                                )),
